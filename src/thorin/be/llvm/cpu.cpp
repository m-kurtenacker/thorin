...
CPUCodeGen::CPUCodeGen(World& w, int opt, bool debug, std::string& target_triple, std::string& target_cpu, std::string& target_attr)
    : CodeGen(w, llvm::CallingConv::C, llvm::CallingConv::C, llvm::CallingConv::C, opt, debug)
{
