...
AMDGPUPALCodeGen::AMDGPUPALCodeGen(World& w, const Cont2Config& kernel_config, int opt, bool debug)
    : AMDGPUCodeGen(w, llvm::CallingConv::AMDGPU_Gfx, llvm::CallingConv::C, llvm::CallingConv::AMDGPU_CS, kernel_config, opt, debug)
{
