...
AMDGPUHSACodeGen::AMDGPUHSACodeGen(World& w, const KernelConfigs& kernel_configs, int opt, bool debug)
    : AMDGPUCodeGen(w, llvm::CallingConv::C, llvm::CallingConv::C, llvm::CallingConv::AMDGPU_KERNEL, kernel_configs, opt, debug)
{
