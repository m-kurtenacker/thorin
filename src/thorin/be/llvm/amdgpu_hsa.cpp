...
AMDGPUHSACodeGen::AMDGPUHSACodeGen(World& w, const Cont2Config& kernel_config, int opt, bool debug)
    : AMDGPUCodeGen(w, llvm::CallingConv::C, llvm::CallingConv::C, llvm::CallingConv::AMDGPU_KERNEL, kernel_config, opt, debug)
{
